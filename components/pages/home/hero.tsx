...
const Hero: React.FC = () => {
    return (
        <section
            className="flex overflow-hidden flex-wrap gap-1 justify-between items-center px-20 py-24 w-full bg-[linear-gradient(180deg,#FFF_0%,#F6FAF4_100%)] max-md:px-5 w-full">
