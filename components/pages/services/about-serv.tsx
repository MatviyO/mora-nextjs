...
const AboutMoraServBuyers: React.FC = () => {
    return (
        <section className="flex items-center w-full justify-center px-10 py-16 bg-[#F6FAF4] relative mx-auto">
            {/* Background SVG Icon */}
...
export default AboutMoraServBuyers;
